...
// Variável para controlar se o dinossauro colidiu recentemente
let colisaoRecente = false;
...
function draw() {
  ...
  if (yDino <= 0) {
    ...
    // Aumenta a velocidade do dinossauro após uma colisão recente
    if (!colisaoRecente) {
      dinoVelocidade += 1; // Aumente o valor como desejar
      colisaoRecente = true;
    }
  } else {
    colisaoRecente = false;
  }
}
